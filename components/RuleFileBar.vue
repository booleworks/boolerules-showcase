    ...
    <div id="br-topbar" class="flex flex-grow-1 p-2 surface-100 border-bottom-1 surface-border">
        <ClientOnly>
            ...
            <div v-else class="flex flex-grow-1 align-items-center">
                ...
                <span class="ml-3 font-bold"># {{ $t('rulefilebar.modules') }}</span>
                <span>: {{ summary.numberOfModules }}</span>
                ...
                <FeatureTags class="ml-4" :boolFeature="summary.hasBooleanFeatures" :enumFeature="summary.hasEnumFeatures"
                    :intFeature="summary.hasIntFeatures" />
            </div>
